...
class Test_Speed_Bumps_Element_Factory extends WP_UnitTestCase {
	...
	public function test_create_non_exists_class() {
		$dummy_class = \Speed_Bumps\Constraint\Element\Speed_Bumps_Element_Factory::build( 'Wrong' );
		$is_dummy_class = is_a( $dummy_class, '\Speed_Bumps\Constraint\Element\Speed_Bumps_Dummy_Constraint' );
